  ...
  return (
    <section aria-label="Radyo durumu" className="border-x border-b border-white/[0.08] bg-[#10080b] px-4 py-3 sm:px-6">
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-[1fr_1.5fr_1fr_1fr_auto] lg:items-center">
        ...
        <div className="flex items-center gap-3"><Users size={17} className="text-rose-400" aria-hidden="true" /><div><p className="text-xs text-stone-400">Dinleyiciler</p><p className="text-sm text-stone-300">Bilgi yakında</p></div></div>
        {hasWhatsapp ? (
