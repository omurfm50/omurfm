    ...
    >
      ...
      {status === 'rendered' && (
        <>
          ...
          <div className="pointer-events-none absolute inset-y-0 left-[68px] right-[82px] z-20 flex items-center overflow-hidden bg-[#5f5f5f] text-[8px] font-semibold leading-[11px] text-amber-100 shadow-[inset_0_1px_0_rgba(255,255,255,.18)] sm:inset-y-auto sm:bottom-auto sm:left-[17%] sm:right-auto sm:top-1/2 sm:block sm:w-[30%] sm:translate-x-0 sm:-translate-y-1/2 sm:rounded-full sm:bg-[#171717]/90 sm:py-1 sm:text-xs sm:leading-normal sm:shadow-[0_0_14px_rgba(0,0,0,.55)]" aria-live="polite" aria-label={`Çalan şarkı: ${nowPlaying}`}>
