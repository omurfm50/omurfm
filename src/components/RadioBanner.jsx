      ...
      <div className="relative grid min-h-[220px] items-center gap-6 px-5 py-8 sm:min-h-[250px] sm:px-8 md:grid-cols-[1fr_auto] lg:px-12">
        <div>
          ...
          <div className="mt-4 flex items-center justify-between gap-3">
            <h1 id="radio-banner-title" className="shrink-0 text-3xl font-black tracking-normal text-white sm:text-5xl">ÖMÜR <span className="text-rose-400">FM</span></h1>
        ...
        <div className="hidden items-center gap-4 border-l-2 border-rose-500/60 bg-black/20 px-4 py-3 backdrop-blur-sm sm:flex sm:min-w-64">
