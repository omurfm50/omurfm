    ...
    <section id="top" aria-labelledby="radio-banner-title" className="relative min-h-[200px] overflow-hidden border-x border-b border-white/[0.08] bg-[#19070d] sm:min-h-[220px] md:min-h-[260px] md:border-white/[0.1] md:bg-[#16070c]">
      ...
      <div className="relative grid min-h-[200px] items-center gap-6 px-5 py-8 sm:min-h-[220px] sm:px-8 md:min-h-[260px] md:grid-cols-[minmax(0,1fr)_20rem] md:gap-12 md:px-12 md:py-10 lg:grid-cols-[minmax(0,1fr)_22rem] lg:px-16">
        <div>
          ...
          <div className="dj-marquee absolute left-5 right-5 bottom-[-10px] overflow-hidden border-y border-white/10 bg-black/40 py-1.5 sm:left-8 sm:right-8 md:left-12 md:right-auto md:w-[calc(100%-12rem)] md:bottom-[-4px]">
        ...
        <div className="hidden items-center gap-4 border-l-2 border-rose-500/60 bg-black/20 px-4 py-3 backdrop-blur-sm sm:flex sm:min-w-64 md:relative md:min-h-40 md:overflow-hidden md:border md:border-white/10 md:bg-black/25 md:px-7 md:py-6 md:shadow-[0_24px_60px_rgba(0,0,0,0.28)] md:backdrop-blur-md">
          ...
          <div className="min-w-0">
            ...
            <div className="radio-equalizer mt-4 hidden h-6 items-end gap-[3px] md:flex" aria-hidden="true">
              {[10, 19, 14, 24, 16, 9, 21, 13, 18, 8, 23, 15, 20, 11, 17].map((height, index) => (
                <span
                  key={index}
